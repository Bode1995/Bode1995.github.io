export function getUI() {
  return {
    ...
    selectedSpecialAbilityLabel: document.getElementById('selectedSpecialAbilityLabel'),
    selectedSpecialAbilityStatus: document.getElementById('selectedSpecialAbilityStatus'),
    ...
    selectedAbilitySummary: document.getElementById('selectedAbilitySummary'),
    specialAbilityUpgradeTracks: document.getElementById('specialAbilityUpgradeTracks'),
