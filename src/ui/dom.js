export function getUI() {
  return {
    ...
    hubMissionButton: document.getElementById('hubMissionButton'),
    hubUpgradeButton: document.getElementById('hubUpgradeButton'),
    hubCharacterButton: document.getElementById('hubCharacterButton'),
    worldGrid: document.getElementById('worldGrid'),
    levelGrid: document.getElementById('levelGrid'),
    skillTree: document.getElementById('skillTree'),
    skillTreeSvg: document.getElementById('skillTreeSvg'),
    upgradeDetail: document.getElementById('upgradeDetail'),
    upgradeCredits: document.getElementById('upgradeCredits'),
    statsGrid: document.getElementById('statsGrid'),
    menuHubButtons: Array.from(document.querySelectorAll('[data-menu-target]')),
    menuBackButtons: Array.from(document.querySelectorAll('[data-menu-back]')),
