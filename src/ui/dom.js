export function getUI() {
  return {
    ...
    upgradeAttackValue: document.getElementById('upgradeAttackValue'),
    upgradeAttackMeta: document.getElementById('upgradeAttackMeta'),
    upgradeDefenseValue: document.getElementById('upgradeDefenseValue'),
    upgradeDefenseMeta: document.getElementById('upgradeDefenseMeta'),
    upgradeSpeedValue: document.getElementById('upgradeSpeedValue'),
    upgradeSpeedMeta: document.getElementById('upgradeSpeedMeta'),
